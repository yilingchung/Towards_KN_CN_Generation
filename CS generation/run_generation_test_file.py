...
def main():
    ...
    parser.add_argument("--do_beam", type=str, default="")
    ...
    output_file = open(args.out_file_path, "w")
        ...
        for line in test_f:
            ...
            if requires_preprocessing:
                ...
                encoded_prompt = tokenizer.encode(prompt_text, add_special_tokens=True,
                                                  return_tensors="pt")  # Yiling changed
            ...
            while "<EOCN>" not in text:
                ...
                for generated_sequence_idx, generated_sequence in enumerate(output_sequences):
                    ...
                    # output_file.write("=== GENERATED SEQUENCE {} ===".format(generated_sequence_idx + 1) + "\n")

...
if __name__ == '__main__':
    ...
    df[['cn_keyword', 'num_cn_keyword']] = df.apply(lambda x: extract_keyphrase("data/CN/", x['cn_id']), axis=1)
    df[['hs_keyword', 'num_hs_keyword']] = df.apply(lambda x: extract_keyphrase("data/HS/", x['cn_id']), axis=1)
